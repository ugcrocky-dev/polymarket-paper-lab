    ...
    <div className="space-y-6">
        ...
        <div className="flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
          <div>
            ...
            <p className="mt-2 max-w-2xl text-[var(--muted)]">
              Net PnL = equity − $1,000 after fees. Cash-starved losers now recycle
              their worst books so they can keep racing — FOMO bars below show who
      ...
      <section className="panel overflow-hidden">
        ...
        <div className="border-t border-[var(--line)] p-4">
          <p className="mb-3 font-mono text-[11px] uppercase tracking-[0.16em] text-[var(--muted)]">
            Cold board · bottom 12 (recovering with capital recycle)
          </p>
